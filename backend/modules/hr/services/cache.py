"""
HR module — in-memory cache (same interface as collections/services/cache.py
and customer_accounts/services/cache.py).

Separate _store dict so HR never shares cache state with other modules.
