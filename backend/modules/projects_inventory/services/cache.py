"""
Projects Inventory module — in-memory cache (same interface as
marketing_attribution/services/cache.py and collections/services/cache.py).

Separate _store dict so this module never shares cache state with other modules.
60-second TTL. Keys include today's Cairo-local date so entries auto-invalidate at
Cairo midnight without an explicit flush.
"""
