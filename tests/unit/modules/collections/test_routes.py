"""
Endpoint integration tests for GET /api/v1/collections/kpi/late-uncollected.

Uses FastAPI TestClient with get_late_uncollected patched — no Odoo connection.
"""
